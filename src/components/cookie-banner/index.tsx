      ...
      <AnimatePresence>
        {isCookieBannerVisible && (
          <m.div
            ...
            className={cn(
              'fixed inset-x-5 bottom-5 z-40 max-h-[70vh] overflow-y-auto rounded-xl border border-border bg-popover px-5 pt-4 shadow-[0px_8px_24px_0px_rgba(0,0,0,0.25)] md:inset-x-8 md:bottom-8',
