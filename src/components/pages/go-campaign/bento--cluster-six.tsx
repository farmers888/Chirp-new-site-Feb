  ...
  return (
    <section className={cn('bento py-12 md:py-14 lg:py-16 xl:py-24', className)}>
      <div className="mx-auto max-w-lg px-5 md:max-w-3xl md:px-8 lg:max-w-5xl xl:max-w-7xl">
        <header className="flex max-w-3xl flex-col xl:mx-auto xl:max-w-5xl">
            ...
            ({ label: cardLabel, title: cardTitle, description: cardDescription }, index) => (
              <li
                className={cn(
                  ...
                  index === 0 || index === 5
                    ? 'col-span-full xl:aspect-[1.11666] xl:max-w-134'
                    : 'xl:aspect-[0.66666] xl:max-w-80',
                  index === 0 || index === 3 || index === 4
                    ? 'lg:aspect-[1.6] lg:max-w-139'
                    : 'lg:aspect-[0.891666] lg:max-w-96',
                )}
                key={index}
              >
