...
function Features({ className, label, title, description, actions, items }: IFeaturesProps) {
  ...
  return (
    <section className={cn('features py-12 md:py-14 lg:py-16 xl:py-24', className)}>
      <div className="mx-auto grid max-w-3xl px-5 md:px-8 lg:max-w-4xl lg:px-0 xl:max-w-7xl xl:px-8">
        <header className="flex w-full max-w-xl flex-col md:max-w-3xl lg:max-w-2xl xl:mx-auto xl:max-w-5xl">
        ...
        <ul className="grid grid-cols-1 gap-9 sm:grid-cols-2 sm:gap-16 lg:grid-cols-3 xl:grid-cols-4">
