  ...
  return (
    <div className={cn(themeSwitcherVariants({ size }), className)}>
      <button
        ...
        className={cn(
          'flex items-center justify-center rounded-full border border-l-0 border-transparent transition-colors duration-300 hover:text-foreground focus-visible:ring-offset-0',
          {
            'size-7': size === 'default',
            'size-8': size === 'md',
          },
      ...
      <button
        ...
        className={cn(
          'flex items-center justify-center rounded-full border border-transparent transition-colors duration-300 hover:text-foreground focus-visible:ring-offset-0',
          {
            'size-7': size === 'default',
            'size-8': size === 'md',
          },
      ...
      <button
        ...
        className={cn(
          'flex items-center justify-center rounded-full border border-r-0 border-transparent transition-colors duration-300 hover:text-foreground focus-visible:ring-offset-0',
          {
            'size-7': size === 'default',
            'size-8': size === 'md',
          },
